...
const FAQ_ITEMS: { question: string; answer: string }[] = [
    {
        ...
        answer: "You can modify or cancel your order within 24 hours of placement. After that, contact support for assistance.",
    },
    {
        question: "Is UrbanTech an authorized Apple reseller?",
        answer: "Yes. UrbanTech is a certified premium reseller with verified documentation.",
    },
    {
        question: "Do you support bulk orders?",
        answer: "Yes. We offer bulk and B2B ordering. Contact our sales team for quotes and delivery options.",
    },
    {
        question: "Is UrbanTech an authorized Apple reseller?",
        answer: "Yes. UrbanTech is a certified premium reseller with verified documentation.",
...
export default function Faq() {
    ...
    return (
        <section className="py-4 w-3/4">
            <h2 className="text-xl sm:text-2xl font-bold text-[#131313] mb-4 sm:mb-6">FAQ&apos;s</h2>
            ...
            <div className="flex gap-4 sm:gap-6 overflow-x-auto scrollbar-hide pb-2 mb-6">
                {FAQ_TABS.map((tab) => (
                    <button
                        ...
                        className={`text-sm font-medium whitespace-nowrap transition shrink-0 ${activeTab === tab
