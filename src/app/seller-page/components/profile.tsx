...
function PlayIcon() {
    return (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="#374151" className="shrink-0 ml-0.5" aria-hidden>
...
function TiktokIcon() {
    return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="shrink-0 text-gray-900">
...
function StarIconSmall({ filled, half }: { filled?: boolean; half?: boolean }) {
    ...
    return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill={filled ? "#eab308" : "none"} stroke="#eab308" strokeWidth="1.5" className="shrink-0">
...
const SAMPLE_REVIEWS = [
    { product: "Iphone 17 Pro Max", date: "2024-07-05 12:00PM", text: "Hi, I'm so glad you like our products. Your best rating is our biggest support. Don't forget to share with your friends, family or relatives. Have a nice day, waiting for your next order." },
    { product: "Iphone 17 Pro Max", date: "2024-07-05 12:00PM", text: "Hi, I'm so glad you like our products. Your best rating is our biggest support. Don't forget to share with your friends, family or relatives. Have a nice day, waiting for your next order." },
    { product: "Iphone 17 Pro Max", date: "2024-07-05 12:00PM", text: "Hi, I'm so glad you like our products. Your best rating is our biggest support. Don't forget to share with your friends, family or relatives. Have a nice day, waiting for your next order." },
    { product: "Iphone 17 Pro Max", date: "2024-07-05 12:00PM", text: "Hi, I'm so glad you like our products. Your best rating is our biggest support. Don't forget to share with your friends, family or relatives. Have a nice day, waiting for your next order." },
    { product: "Iphone 17 Pro Max", date: "2024-07-05 12:00PM", text: "Hi, I'm so glad you like our products. Your best rating is our biggest support. Don't forget to share with your friends, family or relatives. Have a nice day, waiting for your next order." },
    { product: "Iphone 17 Pro Max", date: "2024-07-04 10:30AM", text: "Hi, I'm so glad you like our products. Your best rating is our biggest support. Don't forget to share with your friends, family or relatives. Have a nice day, waiting for your next order." },
];
                        ...
                        <div className="space-y-3">
                            {RATING_BARS.map(({ stars, percent, color }) => (
                                <div key={stars} className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm text-[#131313] w-10 text-right shrink-0">{percent}%</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap items-center gap-4 mb-6">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <div className="flex justify-center items-center gap-3">
                            <label htmlFor="profile-product-cat" className="text-xs font-semibold text-[#131313]">Product Category</label>
                            <div className="relative">
                                <select
                                    id="profile-product-cat"
                                    className="pl-3 pr-8 py-2 rounded-lg border border-gray-200 bg-white text-sm text-gray-700 appearance-none cursor-pointer min-w-[140px]"
                        ...
                        <div className="flex justify-center items-center gap-3">
                            <label htmlFor="profile-ratings" className="text-xs font-semibold text-[#131313]">Ratings</label>
                            <div className="relative">
                                <select
                                    id="profile-ratings"
                                    className="pl-3 pr-8 py-2 rounded-lg border border-gray-200 bg-white text-sm text-gray-700 appearance-none cursor-pointer min-w-[100px]"
                                    defaultValue="4"
                                >
                        ...
                        <article key={i} className=" bg-white p-4">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="flex items-center gap-2 min-w-0 bg-gray-100 rounded-full p-2">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#374151" strokeWidth="2" className="shrink-0" aria-hidden>
                            ...
                            <div className="flex flex-col gap-0.5 mb-2 ml-10">
                                <span className="text-sm font-bold text-[#131313] truncate mb-1">{review.product}</span>
                                <div className="flex items-center gap-0.5">
