  ...
  return (
    <section className="py-4">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg sm:text-xl font-bold ">Recently Searched from this store</h2>
      </div>
      <div className="grid grid-cols-2 gap-3 sm:gap-4 min-w-0 max-w-2xl">
        {RECENTLY_SEARCHED.slice(0, 2).map((product) => (
