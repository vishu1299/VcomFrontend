...
const ASPECTS = [
  ...
  {
    id: "responsiveness",
    label: "Seller Responsiveness (if contacted)",
    defaultRating: 3,
  },
  { id: "value", label: "Value for Money", defaultRating: 4 },
  {
    id: "livestream",
    label: "Livestream Experience (if applicable)",
    defaultRating: 3,
  },
];
...
function StarSmallIcon({ filled }: { filled: boolean }) {
  return (
    <svg
      ...
      height="18"
      viewBox="0 0 24 24"
      fill={filled ? STAR_COLOR_FILLED : "none"}
      stroke={filled ? STAR_COLOR_FILLED : STAR_COLOR_EMPTY}
      strokeWidth="1.5"
      strokeLinecap="round"
...
export default function RateSpecificAspects({
  ratings,
  onRatingChange,
}: RateSpecificAspectsProps) {
  return (
