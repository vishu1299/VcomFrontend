...
const TAGS: { id: string; label: string; dotColor: string; icon?: "star" | "plus" }[] = [
...
function StarSmallIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="#F2C231" stroke="#F2C231" strokeWidth="1.5" className="shrink-0">
      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
    </svg>
  );
}

export default function QuickExperienceTags({ selectedIds, onToggle }: QuickExperienceTagsProps) {
  ...
  return (
    <section className="mb-8">
      <h2 className="text-base font-bold text-[#131313]">
        Quick Experience Tags <span className="text-sm font-normal text-gray-500">(Optional)</span>
      </h2>
      <p className="text-sm text-gray-500 mt-0.5 mb-4">Select up to 3 tags that describe your experience</p>
          ...
          return (
            ...
            >
              ...
              {tag.icon === "star" ? (
                ...
                <span className="text-[#3581EA]" style={{ color: tag.dotColor }}>
                  <PlusIcon />
                </span>
              ) : (
                <span
              ...
              <span className="text-sm font-medium text-[#131313]">{tag.label}</span>
              </div>
              <input
                type="checkbox"
                checked={isSelected}
