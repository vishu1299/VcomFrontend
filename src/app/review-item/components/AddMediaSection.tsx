function CameraPlusIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="shrink-0 text-gray-400 mx-auto">
  ...
  return (
    <section className="mb-8">
      <label className="block text-sm font-medium text-[#131313] mb-2">
        ...
        <span className="text-xs font-normal text-gray-500">(Optional – max 5 images, 1 video up to 15 seconds)</span>
      </label>
