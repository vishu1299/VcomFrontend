    ...
    <article className="bg-white rounded-xl sm:rounded-2xl border border-[#e5e7eb] overflow-hidden shadow-sm hover:shadow transition flex flex-col">
      ...
      >
        <div className="relative z-10 bg-white flex justify-between items-start gap-1 p-1.5 sm:p-2">
          <span className="bg-[#F5B700] text-[#131313] text-[9px] sm:text-[10px] md:text-[11px] font-semibold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-l-none rounded-r-md shadow-sm max-w-[45%] sm:max-w-[55%] truncate">
            {scheduledDate}
          </span>
      ...
      <div className="p-2 sm:p-3 md:p-4 flex flex-col flex-1 min-w-0">
        ...
        <div className="mt-auto flex flex-row gap-1.5 sm:gap-2">
          ...
          <button
            type="button"
            className="w-1/2 min-w-0 px-2 py-2 sm:px-3 sm:py-2 rounded-lg bg-[#dc2626] text-white text-[10px] font-bold flex items-center justify-center gap-1 sm:gap-2 hover:opacity-95 transition"
          >
