...
const DETAILS = [
  ...
  { label: "Shipping Address", value: "FT-43 Street NO.32, New Delhi", icon: "location" },
  ...
  { label: "Tracking Number", value: TRACKING_NUMBER, icon: "location", copyable: true },
];

function PersonIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 text-gray-500">
...
function CopyIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 cursor-pointer hover:text-blue-600 inline-block align-middle ml-1" aria-hidden>
...
export default function ShipmentDetails() {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-[#131313] mb-4">Shipment Details</h2>
            ...
            <div key={label} className="flex items-start sm:items-center gap-3">
              ...
              <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-0.5 sm:gap-4">
                ...
                <dd className="text-sm text-[#131313] flex items-center">
                  {value}
                  {copyable && (
                    <button type="button" onClick={handleCopy} className="p-0.5" aria-label="Copy tracking number">
                      <CopyIcon />
                    </button>
                  )}
                </dd>
