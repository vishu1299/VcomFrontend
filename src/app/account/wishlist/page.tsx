...
const MOCK_WISHLIST: WishlistProduct[] = [
  { id: '1', name: 'iPhone 17 Pro 256 GB: 15.93 cm (6.3") Display', price: '$299.00', image: '/images/phone.png', color: 'Orange', size: '6.2INCH' },
...
function WishlistProductCard({ product, onRemove }: { product: WishlistProduct; onRemove: (id: string) => void }) {
...
export default function WishlistPage() {
  ...
  const [wishlistProducts, setWishlistProducts] = useState<WishlistProduct[]>(MOCK_WISHLIST);
  ...
  return (
    <div className="px-2 lg:px-8 pt-2 lg:pt-2 pb-4 lg:pb-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[var(--color-black-01)] mb-1">Wishlist</h1>
          <p className="text-[14px] text-[var(--color-muted-alt-2)]">Here&apos;s your wishlist products</p>
        </div>
      ...
      {/* Item related to Wishlist - align first card with wishlist grid; arrows half over first/last card */}
      <div className="mb-6 overflow-visible">
        <h2 className="text-lg font-bold text-[var(--color-black-01)] mb-4">Item related to Wishlist</h2>
