  ...
  return (
    ...
    >
      <div className="px-4 sm:px-6 lg:px-8 pt-5 sm:pt-6 pb-4 lg:pb-5">
        ...
        {/* Header: title row, subtitle below (same typography/colors as before) */}
        <div className="mb-4 lg:mb-5 flex flex-col gap-0">
          <h2 className="font-bold text-design-18 sm:text-design-20 lg:text-design-24 mb-1.5 leading-tight text-[#FB0092]">
            Top Deals
          </h2>
