...
const ORDER_SUMMARY = [
  ...
  { label: "Estimated Delivery Date:", value: "16, Nov, 2025" },
  {
    ...
    value: "Josh 21, Green Avenue, Tilak Nagar, New Delhi, 110018",
  },
];
    ...
    <div className=" bg-white mb-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div className="flex flex-wrap items-center gap-2">
          <h2 className="text-lg font-bold text-[#131313]">
            Order Details #ORD-434231
          </h2>
        ...
        <div className="flex gap-4  rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[#131313] mt-1">
              Color: <span className=" font-bold text-black">Orange</span> QTY:{" "}
              <span className=" font-bold text-black">1</span>{" "}
              <span className=" font-bold text-black">
                Product Number: 43-4234324
              </span>
            </p>
          ...
          <dl className="space-y-2 text-sm">
            {ORDER_SUMMARY.map(({ label, value }) => (
              <div key={label} className="flex justify-between gap-3">
                ...
                <dd className="text-[#131313] text-right min-w-0 break-words">
                  {value}
                </dd>
              </div>
            ))}
