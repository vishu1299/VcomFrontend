...
const MOCK_ARTICLES = [
  {
    id: "1",
    title: "How do I return an item on TibilMall?",
    image: "/images/artical1.png",
    tab: "General",
  },
  {
    id: "2",
    title: "How can I track my order?",
    image: "/images/artical2.png",
    tab: "General",
  },
  {
    id: "3",
  ...
  {
    id: "6",
    title: "What are the return policies for different items?",
    image: "/images/artical2.png",
    tab: "General",
  },
  {
    id: "7",
    title: "I didn't receive my product - what should I do?",
    image: "/images/artical1.png",
    tab: "General",
  },
  {
    id: "8",
    title: "Can I ship to a different address?",
    image: "/images/artical2.png",
    tab: "General",
  },
];
...
function ArticleCard({
  ...
  return (
    <div
      className="shrink-0 w-[280px] sm:w-[300px] flex flex-col rounded-xl border bg-white overflow-hidden"
    ...
    >
      ...
      <div className="px-4 pb-4 flex flex-col flex-1 min-h-0">
        <h3 className="text-sm font-bold text-black mb-3 line-clamp-2 min-h-[2.5rem]">
          {title}
        </h3>
        <Link
          href={`/help/${id}`}
...
export default function HelpArticleDetailPage() {
  ...
  const filteredArticles = MOCK_ARTICLES.filter(
    (a) => a.tab === activeArticleTab,
  );
  const moreArticles = (
    filteredArticles.length ? filteredArticles : MOCK_ARTICLES
  ).filter((a) => a.id !== id);
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-6">
            <h1 className="text-xl sm:text-2xl font-bold text-black flex-1">
              {article.title}
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
            <div>
              ...
              <div
                className="rounded-lg aspect-video flex items-center justify-center min-h-[140px]"
          ...
          <div className="pt-0">
            ...
            <div className="relative">
              ...
              >
                {(moreArticles.length
                  ? moreArticles
                  : MOCK_ARTICLES.filter((a) => a.id !== id)
                ).map((a) => (
                  <ArticleCard
                    key={a.id}
                    id={a.id}
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-start justify-between gap-4 mb-2">
                  <div>
                    ...
                    <p className="text-sm mt-1" style={{ color: "#767676" }}>
                      We&apos;re here to help you – whether you&apos;re a
                      shopper, seller, or just curious. Reach out and let&apos;s
                      connect.
                    </p>
                  </div>
                  <button
                ...
                <p className="text-sm font-bold text-black mt-5 mb-2">
